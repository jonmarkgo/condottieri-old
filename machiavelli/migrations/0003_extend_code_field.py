...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.code'
        db.alter_column('machiavelli_area', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

    def backwards(self, orm):

        # Changing field 'Area.code'
        db.alter_column('machiavelli_area', 'code', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True))
