...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Order', fields ['player', 'unit']
        db.delete_unique('machiavelli_order', ['player_id', 'unit_id'])
        ...
        # Adding unique constraint on 'Order', fields ['confirmed', 'unit']
        db.create_unique('machiavelli_order', ['confirmed', 'unit_id'])

        # Adding field 'Configuration.bribes_via_ally'
        db.add_column('machiavelli_configuration', 'bribes_via_ally',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.bribes_anywhere'
        db.add_column('machiavelli_configuration', 'bribes_anywhere',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.random_assassins'
        db.add_column('machiavelli_configuration', 'random_assassins',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.no_luck'
        db.add_column('machiavelli_configuration', 'no_luck',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Order', fields ['confirmed', 'unit']
        db.delete_unique('machiavelli_order', ['confirmed', 'unit_id'])
        ...
        # Adding unique constraint on 'Order', fields ['player', 'unit']
        db.create_unique('machiavelli_order', ['player_id', 'unit_id'])

        # Deleting field 'Configuration.bribes_via_ally'
        db.delete_column('machiavelli_configuration', 'bribes_via_ally')

        # Deleting field 'Configuration.bribes_anywhere'
        db.delete_column('machiavelli_configuration', 'bribes_anywhere')

        # Deleting field 'Configuration.random_assassins'
        db.delete_column('machiavelli_configuration', 'random_assassins')

        # Deleting field 'Configuration.no_luck'
        db.delete_column('machiavelli_configuration', 'no_luck')
